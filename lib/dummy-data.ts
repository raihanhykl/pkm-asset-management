...
export const dummyAssetRequests: AssetRequest[] = [
  ...
  },
  {
    ...
    requester_id: 3,
    requester: dummyUsers[2],
    department: "Lab Kimia",
    purpose: "Peralatan lab untuk praktikum",
    status: "draft",
    ...
    items: [
      {
        ...
        specification: "1000x magnification",
        quantity: 5,
