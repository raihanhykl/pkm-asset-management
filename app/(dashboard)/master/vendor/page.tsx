...
import { DataTableActions } from "@/components/shared/data-table-action";
import { VendorFormData, vendorSchema } from "@/lib/schemas/vendor.schema";
// import { vendorSchema, VendorFormData } from '@/lib/schemas/vendor.schema';
...
export default function VendorListPage() {
  ...
  const updateMutation = useUpdateVendor(editingVendor?.id || 0);
  ...
  if (isLoading) {
    return <LoadingPage text="Memuat data vendor..." />;
  }
