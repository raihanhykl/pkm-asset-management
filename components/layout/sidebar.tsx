...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { title: "Aset", href: "/master/aset", icon: Package },
      { title: "Kategori", href: "/master/kategori", icon: Tags },
      { title: "Lokasi", href: "/master/lokasi", icon: MapPin },
      { title: "Vendor", href: "/master/vendor", icon: Building2 },
      {
        title: "Pengguna",
        href: "/master/pengguna",
  ...
  },
  {
    ...
    icon: FileText,
    children: [
      { title: "Permohonan Asset", href: "/permohonan-aset", icon: FileText },
      {
      ...
      { title: "Order Asset (PO)", href: "/order-aset", icon: ShoppingCart },
      {
...
function NavItemComponent({
  ...
  if (item.children) {
    const hasAccess = item.children.some(
      (child) =>
        !child.roles || (user && child.roles.includes(user.role?.name || ""))
    );
    if (!hasAccess) return null;
